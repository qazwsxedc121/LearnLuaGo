...
var opcodes = []opcode{
	...
	opcode{0, 1, OpArgR, OpArgR, IABC, "GETI", nil},
	opcode{0, 1, OpArgR, OpArgK, IABC, "GETFIELD", nil},
	opcode{0, 1, OpArgK, OpArgK, IABC, "SETTABUP", nil},
	opcode{0, 0, OpArgK, OpArgK, IABC, "SETTABLE", nil},
	opcode{0, 0, OpArgK, OpArgK, IABC, "SETI", nil},
	opcode{0, 0, OpArgK, OpArgK, IABC, "SETFIELD", nil},
